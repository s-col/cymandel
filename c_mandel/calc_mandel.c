...
#define __PYX_HAVE__c_mandel__calc_mandel
#define __PYX_HAVE_API__c_mandel__calc_mandel
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'c_mandel.calc_mandel' */
...
static void __pyx_f_8c_mandel_11calc_mandel_csquare(double *, double, double); /*proto*/
static int __pyx_f_8c_mandel_11calc_mandel_calc(double, double, int, double); /*proto*/
static void __pyx_f_8c_mandel_11calc_mandel_hsv2bgr(unsigned char *, double, double, double); /*proto*/
...
#define __Pyx_MODULE_NAME "c_mandel.calc_mandel"
extern int __pyx_module_is_main_c_mandel__calc_mandel;
int __pyx_module_is_main_c_mandel__calc_mandel = 0;

/* Implementation of 'c_mandel.calc_mandel' */
...
static const char __pyx_k_x_fig[] = "x_fig";
static const char __pyx_k_y_fig[] = "y_fig";
...
static const char __pyx_k_clr_lst[] = "clr_lst";
...
static const char __pyx_k_get_mandel_array[] = "get_mandel_array";
static const char __pyx_k_pyx_unpickle_Enum[] = "__pyx_unpickle_Enum";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_strided_and_direct[] = "<strided and direct>";
static const char __pyx_k_c_mandel_calc_mandel[] = "c_mandel.calc_mandel";
...
static const char __pyx_k_c_mandel_calc_mandel_pyx[] = "c_mandel\\calc_mandel.pyx";
...
static PyObject *__pyx_n_s_c_mandel_calc_mandel;
static PyObject *__pyx_kp_s_c_mandel_calc_mandel_pyx;
static PyObject *__pyx_n_s_class;
static PyObject *__pyx_n_s_cline_in_traceback;
static PyObject *__pyx_n_s_close;
static PyObject *__pyx_n_s_clr_lst;
...
static PyObject *__pyx_n_s_get_mandel_array;
...
static PyObject *__pyx_n_s_x_fig;
static PyObject *__pyx_n_s_y0;
static PyObject *__pyx_n_s_y1;
static PyObject *__pyx_n_s_y_fig;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_8c_mandel_11calc_mandel_get_mandel_array(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_x0, double __pyx_v_x1, double __pyx_v_y0, double __pyx_v_y1, int __pyx_v_w, int __pyx_v_inf, double __pyx_v_lim); /* proto */
...
static void __pyx_f_8c_mandel_11calc_mandel_csquare(double *__pyx_v_s, double __pyx_v_x, double __pyx_v_y) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("csquare", 0);

  /* "c_mandel/calc_mandel.pyx":10
 * 
 * cdef void csquare(double s[], double x, double y):
 *     s[0] = x*x - y*y             # <<<<<<<<<<<<<<
 *     s[1] = 2.0 * x * y
 * 
 */
  (__pyx_v_s[0]) = ((__pyx_v_x * __pyx_v_x) - (__pyx_v_y * __pyx_v_y));

  /* "c_mandel/calc_mandel.pyx":11
 * cdef void csquare(double s[], double x, double y):
 *     s[0] = x*x - y*y
 *     s[1] = 2.0 * x * y             # <<<<<<<<<<<<<<
 * 
 * 
 */
  (__pyx_v_s[1]) = ((2.0 * __pyx_v_x) * __pyx_v_y);
...
static int __pyx_f_8c_mandel_11calc_mandel_calc(double __pyx_v_cx, double __pyx_v_cy, int __pyx_v_inf, double __pyx_v_lim) {
  double __pyx_v_x;
  double __pyx_v_y;
  int __pyx_v_n;
  double __pyx_v_s[2];
 ...
 */
  while (1) {
    __pyx_t_2 = ((__pyx_v_n < __pyx_v_inf) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L5_bool_binop_done;
    }
    __pyx_t_2 = ((((__pyx_v_x * __pyx_v_x) + (__pyx_v_y * __pyx_v_y)) < __pyx_v_lim) != 0);
    __pyx_t_1 = __pyx_t_2;
    __pyx_L5_bool_binop_done:;
    if (!__pyx_t_1) break;

    /* "c_mandel/calc_mandel.pyx":21
 *     cdef double s[2]
 *     while n < inf and x*x + y*y < lim:
 *         csquare(s, x, y)             # <<<<<<<<<<<<<<
 *         x = s[0] + cx
 *         y = s[1] + cy
 */
    __pyx_f_8c_mandel_11calc_mandel_csquare(__pyx_v_s, __pyx_v_x, __pyx_v_y);

    /* "c_mandel/calc_mandel.pyx":22
 *     while n < inf and x*x + y*y < lim:
 *         csquare(s, x, y)
 *         x = s[0] + cx             # <<<<<<<<<<<<<<
 *         y = s[1] + cy
 *         n = n + 1
 */
    __pyx_v_x = ((__pyx_v_s[0]) + __pyx_v_cx);

    /* "c_mandel/calc_mandel.pyx":23
 *         csquare(s, x, y)
 *         x = s[0] + cx
 *         y = s[1] + cy             # <<<<<<<<<<<<<<
 *         n = n + 1
 *     return n
 */
    __pyx_v_y = ((__pyx_v_s[1]) + __pyx_v_cy);

    /* "c_mandel/calc_mandel.pyx":24
 *         x = s[0] + cx
 *         y = s[1] + cy
 *         n = n + 1             # <<<<<<<<<<<<<<
 *     return n
...
static void __pyx_f_8c_mandel_11calc_mandel_hsv2bgr(unsigned char *__pyx_v_clr_lst, double __pyx_v_h, double __pyx_v_s, double __pyx_v_v) {
  double __pyx_v_b;
  double __pyx_v_g;
  double __pyx_v_r;
  int __pyx_v_hi;
  ...
  double __pyx_v_t;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("hsv2bgr", 0);

  /* "c_mandel/calc_mandel.pyx":30
 * cdef void hsv2bgr(unsigned char clr_lst[], double h, double s, double v):
 *     cdef double b, g, r
 *     cdef int hi = <int>(h / 60) % 6             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_hi = __Pyx_mod_long(((int)(__pyx_v_h / 60.0)), 6);

  /* "c_mandel/calc_mandel.pyx":31
 *     cdef double b, g, r
 *     cdef int hi = <int>(h / 60) % 6
 *     cdef double f = h / 60 - hi             # <<<<<<<<<<<<<<
 *     cdef double p = v * (1.0 - s)
 ...
 */
  __pyx_v_f = ((__pyx_v_h / 60.0) - __pyx_v_hi);

  /* "c_mandel/calc_mandel.pyx":32
 *     cdef int hi = <int>(h / 60) % 6
 *     cdef double f = h / 60 - hi
 *     cdef double p = v * (1.0 - s)             # <<<<<<<<<<<<<<
 *     cdef double q = v * (1.0 - f * s)
 ...
 */
  (__pyx_v_clr_lst[0]) = ((unsigned char)(__pyx_v_b * 255.0));

  /* "c_mandel/calc_mandel.pyx":61
 * 
 *     clr_lst[0] = <unsigned char>(b * 255.0)
 *     clr_lst[1] = <unsigned char>(g * 255.0)             # <<<<<<<<<<<<<<
 *     clr_lst[2] = <unsigned char>(r * 255.0)
 * 
 */
  (__pyx_v_clr_lst[1]) = ((unsigned char)(__pyx_v_g * 255.0));

  /* "c_mandel/calc_mandel.pyx":62
 *     clr_lst[0] = <unsigned char>(b * 255.0)
 *     clr_lst[1] = <unsigned char>(g * 255.0)
 *     clr_lst[2] = <unsigned char>(r * 255.0)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  (__pyx_v_clr_lst[2]) = ((unsigned char)(__pyx_v_r * 255.0));
...
/* Python wrapper */
static PyObject *__pyx_pw_8c_mandel_11calc_mandel_1get_mandel_array(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_8c_mandel_11calc_mandel_1get_mandel_array = {"get_mandel_array", (PyCFunction)__pyx_pw_8c_mandel_11calc_mandel_1get_mandel_array, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_8c_mandel_11calc_mandel_1get_mandel_array(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  double __pyx_v_x0;
  double __pyx_v_x1;
  double __pyx_v_y0;
  double __pyx_v_y1;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_mandel_array (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x0,&__pyx_n_s_x1,&__pyx_n_s_y0,&__pyx_n_s_y1,&__pyx_n_s_w,&__pyx_n_s_inf,&__pyx_n_s_lim,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x1)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("get_mandel_array", 1, 7, 7, 1); __PYX_ERR(0, 67, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_mandel_array", 1, 7, 7, 2); __PYX_ERR(0, 67, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_mandel_array", 1, 7, 7, 3); __PYX_ERR(0, 67, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_w)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_mandel_array", 1, 7, 7, 4); __PYX_ERR(0, 67, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_inf)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_mandel_array", 1, 7, 7, 5); __PYX_ERR(0, 67, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lim)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_mandel_array", 1, 7, 7, 6); __PYX_ERR(0, 67, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_mandel_array") < 0)) __PYX_ERR(0, 67, __pyx_L3_error)
      }
    ...
    __pyx_v_x0 = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_x0 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 68, __pyx_L3_error)
    __pyx_v_x1 = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_x1 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 68, __pyx_L3_error)
    __pyx_v_y0 = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_y0 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 68, __pyx_L3_error)
    __pyx_v_y1 = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_y1 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 68, __pyx_L3_error)
    __pyx_v_w = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_w == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 69, __pyx_L3_error)
    __pyx_v_inf = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_inf == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 69, __pyx_L3_error)
    __pyx_v_lim = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_lim == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 69, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_mandel_array", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 67, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("c_mandel.calc_mandel.get_mandel_array", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8c_mandel_11calc_mandel_get_mandel_array(__pyx_self, __pyx_v_x0, __pyx_v_x1, __pyx_v_y0, __pyx_v_y1, __pyx_v_w, __pyx_v_inf, __pyx_v_lim);
...
static PyObject *__pyx_pf_8c_mandel_11calc_mandel_get_mandel_array(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_x0, double __pyx_v_x1, double __pyx_v_y0, double __pyx_v_y1, int __pyx_v_w, int __pyx_v_inf, double __pyx_v_lim) {
  double __pyx_v_dx;
  double __pyx_v_dy;
  double __pyx_v_cx;
  double __pyx_v_cy;
  ...
  int __pyx_v_y_fig;
  int __pyx_v_h;
  unsigned char __pyx_v_clr_lst[3];
  ...
  __Pyx_RefNannySetupContext("get_mandel_array", 0);

  /* "c_mandel/calc_mandel.pyx":71
 *         int w, int inf, double lim):
 * 
 ...
 */
  ...
  __pyx_v_dx = (__pyx_t_1 / __pyx_v_w);

  /* "c_mandel/calc_mandel.pyx":72
 * 
 *     cdef double dx = (x1 - x0) / w
 *     cdef double dy = (y1 - y0) / w             # <<<<<<<<<<<<<<
 *     cdef double cx = x0
 ...
 */
  ...
  __pyx_v_dy = (__pyx_t_1 / __pyx_v_w);

  /* "c_mandel/calc_mandel.pyx":73
 *     cdef double dx = (x1 - x0) / w
 *     cdef double dy = (y1 - y0) / w
 *     cdef double cx = x0             # <<<<<<<<<<<<<<
 *     cdef double cy = y1
 ...
 */
  __pyx_v_cx = __pyx_v_x0;

  /* "c_mandel/calc_mandel.pyx":74
 *     cdef double dy = (y1 - y0) / w
 *     cdef double cx = x0
 *     cdef double cy = y1             # <<<<<<<<<<<<<<
 *     cdef int x_fig, y_fig
 *     cdef int h
 */
  __pyx_v_cy = __pyx_v_y1;

  /* "c_mandel/calc_mandel.pyx":79
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_w); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 79, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPE); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     pbar = tqdm(total=w)
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_unsigned_char(__pyx_v_img_np, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 80, __pyx_L1_error)
  __pyx_v_img = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "c_mandel/calc_mandel.pyx":82
 *     cdef unsigned char[:, :, ::1] img = img_np
 * 
 *     pbar = tqdm(total=w)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_tqdm); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_total, __pyx_t_4) < 0) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_empty_tuple, __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    __pyx_v_x_fig = __pyx_t_9;

    /* "c_mandel/calc_mandel.pyx":85
 * 
 *     for x_fig in range(w):
 *         for y_fig in range(w):             # <<<<<<<<<<<<<<
 *             h = calc(cx, cy, inf, lim)
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      __pyx_v_y_fig = __pyx_t_12;

      /* "c_mandel/calc_mandel.pyx":86
 *     for x_fig in range(w):
 *         for y_fig in range(w):
 *             h = calc(cx, cy, inf, lim)             # <<<<<<<<<<<<<<
 *             if h == inf:
 ...
 */
      __pyx_v_h = __pyx_f_8c_mandel_11calc_mandel_calc(__pyx_v_cx, __pyx_v_cy, __pyx_v_inf, __pyx_v_lim);

      /* "c_mandel/calc_mandel.pyx":87
 *         for y_fig in range(w):
 *             h = calc(cx, cy, inf, lim)
 *             if h == inf:             # <<<<<<<<<<<<<<
 *                 clr_lst[0] = clr_lst[1] = clr_lst[2] = 0
 *             else:
 */
      __pyx_t_13 = ((__pyx_v_h == __pyx_v_inf) != 0);
      if (__pyx_t_13) {

        /* "c_mandel/calc_mandel.pyx":88
 *             h = calc(cx, cy, inf, lim)
 *             if h == inf:
 *                 clr_lst[0] = clr_lst[1] = clr_lst[2] = 0             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      /*else*/ {
        __pyx_f_8c_mandel_11calc_mandel_hsv2bgr(__pyx_v_clr_lst, (((double)__pyx_v_h) * 3.0), 1.0, 1.0);
      }
      __pyx_L7:;

      /* "c_mandel/calc_mandel.pyx":92
 *                 hsv2bgr(clr_lst, <double>h*3, 1.0, 1.0)
 * 
 *             img[x_fig, y_fig, 0] = clr_lst[2]             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_14 = __pyx_v_x_fig;
      __pyx_t_15 = __pyx_v_y_fig;
      __pyx_t_16 = 0;
      *((unsigned char *) ( /* dim=2 */ ((char *) (((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img.data + __pyx_t_14 * __pyx_v_img.strides[0]) ) + __pyx_t_15 * __pyx_v_img.strides[1]) )) + __pyx_t_16)) )) = (__pyx_v_clr_lst[2]);

      /* "c_mandel/calc_mandel.pyx":93
 * 
 *             img[x_fig, y_fig, 0] = clr_lst[2]
 *             img[x_fig, y_fig, 1] = clr_lst[1]             # <<<<<<<<<<<<<<
 *             img[x_fig, y_fig, 2] = clr_lst[0]
 *             # ,
 */
      __pyx_t_17 = __pyx_v_x_fig;
      __pyx_t_18 = __pyx_v_y_fig;
      __pyx_t_19 = 1;
      *((unsigned char *) ( /* dim=2 */ ((char *) (((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img.data + __pyx_t_17 * __pyx_v_img.strides[0]) ) + __pyx_t_18 * __pyx_v_img.strides[1]) )) + __pyx_t_19)) )) = (__pyx_v_clr_lst[1]);

      /* "c_mandel/calc_mandel.pyx":94
 *             img[x_fig, y_fig, 0] = clr_lst[2]
 *             img[x_fig, y_fig, 1] = clr_lst[1]
 *             img[x_fig, y_fig, 2] = clr_lst[0]             # <<<<<<<<<<<<<<
 *             # ,
 * 
 */
      __pyx_t_20 = __pyx_v_x_fig;
      __pyx_t_21 = __pyx_v_y_fig;
      __pyx_t_22 = 2;
      *((unsigned char *) ( /* dim=2 */ ((char *) (((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img.data + __pyx_t_20 * __pyx_v_img.strides[0]) ) + __pyx_t_21 * __pyx_v_img.strides[1]) )) + __pyx_t_22)) )) = (__pyx_v_clr_lst[0]);

      /* "c_mandel/calc_mandel.pyx":97
 *             # ,
 * 
 *             cx += dx             # <<<<<<<<<<<<<<
 * 
 *         cx = x0
 */
      __pyx_v_cx = (__pyx_v_cx + __pyx_v_dx);
    }

    /* "c_mandel/calc_mandel.pyx":99
 *             cx += dx
 * 
 *         cx = x0             # <<<<<<<<<<<<<<
 *         cy -= dy
 ...
 *     pbar.close()
 */
    __pyx_v_cy = (__pyx_v_cy - __pyx_v_dy);

    /* "c_mandel/calc_mandel.pyx":101
 *         cx = x0
 *         cy -= dy
 *         pbar.update(1)             # <<<<<<<<<<<<<<
 *     pbar.close()
 *     return img_np
 */
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_pbar, __pyx_n_s_update); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  }

  /* "c_mandel/calc_mandel.pyx":102
 *         cy -= dy
 *         pbar.update(1)
 *     pbar.close()             # <<<<<<<<<<<<<<
 *     return img_np
 */
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_pbar, __pyx_n_s_close); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 102, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = NULL;
  ...
  if (__pyx_t_2) {
    __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_t_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 102, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  } else {
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "c_mandel.calc_mandel.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "c_mandel.calc_mandel.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "c_mandel.calc_mandel.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "c_mandel.calc_mandel._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_calc_mandel(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_calc_mandel},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_c_mandel_calc_mandel, __pyx_k_c_mandel_calc_mandel, sizeof(__pyx_k_c_mandel_calc_mandel), 0, 0, 1, 1},
  {&__pyx_kp_s_c_mandel_calc_mandel_pyx, __pyx_k_c_mandel_calc_mandel_pyx, sizeof(__pyx_k_c_mandel_calc_mandel_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_class, __pyx_k_class, sizeof(__pyx_k_class), 0, 0, 1, 1},
  {&__pyx_n_s_cline_in_traceback, __pyx_k_cline_in_traceback, sizeof(__pyx_k_cline_in_traceback), 0, 0, 1, 1},
  {&__pyx_n_s_close, __pyx_k_close, sizeof(__pyx_k_close), 0, 0, 1, 1},
  {&__pyx_n_s_clr_lst, __pyx_k_clr_lst, sizeof(__pyx_k_clr_lst), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_get_mandel_array, __pyx_k_get_mandel_array, sizeof(__pyx_k_get_mandel_array), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_x_fig, __pyx_k_x_fig, sizeof(__pyx_k_x_fig), 0, 0, 1, 1},
  {&__pyx_n_s_y0, __pyx_k_y0, sizeof(__pyx_k_y0), 0, 0, 1, 1},
  {&__pyx_n_s_y1, __pyx_k_y1, sizeof(__pyx_k_y1), 0, 0, 1, 1},
  {&__pyx_n_s_y_fig, __pyx_k_y_fig, sizeof(__pyx_k_y_fig), 0, 0, 1, 1},
 ...
 *         int w, int inf, double lim):
 */
  __pyx_tuple__23 = PyTuple_Pack(18, __pyx_n_s_x0, __pyx_n_s_x1, __pyx_n_s_y0, __pyx_n_s_y1, __pyx_n_s_w, __pyx_n_s_inf, __pyx_n_s_lim, __pyx_n_s_dx, __pyx_n_s_dy, __pyx_n_s_cx, __pyx_n_s_cy, __pyx_n_s_x_fig, __pyx_n_s_y_fig, __pyx_n_s_h, __pyx_n_s_clr_lst, __pyx_n_s_img_np, __pyx_n_s_img, __pyx_n_s_pbar); if (unlikely(!__pyx_tuple__23)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__23);
  __Pyx_GIVEREF(__pyx_tuple__23);
  __pyx_codeobj__24 = (PyObject*)__Pyx_PyCode_New(7, 0, 18, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__23, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_c_mandel_calc_mandel_pyx, __pyx_n_s_get_mandel_array, 67, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__24)) __PYX_ERR(0, 67, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcalc_mandel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcalc_mandel(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_calc_mandel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_calc_mandel(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_calc_mandel(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_calc_mandel(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("calc_mandel", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_c_mandel__calc_mandel) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "c_mandel.calc_mandel")) {
      if (unlikely(PyDict_SetItemString(modules, "c_mandel.calc_mandel", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *         int w, int inf, double lim):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8c_mandel_11calc_mandel_1get_mandel_array, NULL, __pyx_n_s_c_mandel_calc_mandel); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_get_mandel_array, __pyx_t_1) < 0) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "c_mandel/calc_mandel.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 * from tqdm import tqdm
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init c_mandel.calc_mandel", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init c_mandel.calc_mandel");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
